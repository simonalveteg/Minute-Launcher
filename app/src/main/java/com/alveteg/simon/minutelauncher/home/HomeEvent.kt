...
sealed class HomeEvent : Event {
  ...
  data class UpdateMindfulDelay(val app: App, val delayValue: Int) : HomeEvent()
  data class ResetMindfulDelayToDefault(val app: App) : HomeEvent()
  ...
  data object HideOnboarding : HomeEvent()
}
